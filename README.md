# com-chilipeppr-workspace-diode_laser
A ChiliPeppr Workspace for inexpensive diode laser machines.



## ChiliPeppr Workspace / diode_laser
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-diode_laser |
| Name                  | Workspace / diode_laser |
| Description           | A ChiliPeppr Workspace for inexpensive diode laser machines. |
...
chilipeppr.load(
  ...
  function() {
    ...
    cprequire(
      ["inline:com-chilipeppr-workspace-diode_laser"], // the id you gave your workspace
      function(myWorkspaceDiode_laser) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / diode_laser just got loaded.", myWorkspaceDiode_laser);
        myWorkspaceDiode_laser.init();
      }
    );
  }
);
