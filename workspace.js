...
cprequire_test(["inline:com-chilipeppr-workspace-diode_laser"], function(ws) {
    ...
    $('title').html("diode_laser Workspace");
...
cpdefine("inline:com-chilipeppr-workspace-diode_laser", ["chilipeppr_ready"], function() {
    return {
        /**
         * The ID of the widget. You must define this and make it unique.
         */
        id: "com-chilipeppr-workspace-diode_laser", // Make the id the same as the cpdefine id
        name: "Workspace / diode_laser", // The descriptive name of your widget.
        desc: `A ChiliPeppr Workspace for inexpensive diode laser machines.`,
